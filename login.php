    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-md-offset-4">
                ...
                <div class="login-panel card1"><!-- has form in it-->
                    ...
                    <div class="form-panel"><center>
                        ...
                        <form role="form" method = "post" enctype = "multipart/form-data" class="index-form">
                            ...
                            <center>Student Login</center><br>
                            </div>
                            
                                
                                <div class="form-field">
									<!-- <label for = "username">Student ID: </label><br/> -->
										<input class="form-control" placeholder="Student ID" name="idno" type="text" required = "required" autofocus>
                                </div>
								<br>
                                <div class="form-field">
